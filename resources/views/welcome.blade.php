            ...
            <div class="home-template content-inner">
                                ...
                                <div class="section-left" data-animation="fadeInRightBig">
                                    <div class="title-wrap margin-bottom-30">
                                        ...
                                        <div class="pad-top-15">
                                            <p class="margin-bottom-20 relative typo-white">ENREMCO is here to support DENR employees with financial services and community programs designed for growth and success.</p>
                                            <h4>What We Offer</h4>
                                            <ul>
                                                <li><b>Savings & Loans:</b> Easy and secure financial solutions.</li>
                                                <li><b>Membership Benefits: </b> Exclusive services for DENR employees.</li>
                                                <li><b>Community Support:</b> Programs that help us grow together</li>
                                            </ul>
                                        </div>
                ...
                <section class="about-us py-10 px-5 bg-white text-gray-800 dark:bg-gray-900 dark:text-white">
                    <div class="max-w-3xl mx-auto text-center">
                        ...
                        <p class="mb-6">
                        Established by dedicated employees of the Department of Environment and Natural Resources (DENR), 
                        ENREMCO (Environment and Natural Resources Employees' Multipurpose Cooperative) began as a simple idea: 
                        to unite the DENR community under a shared vision of progress and sustainability. 
                        Over the years, we have grown into a supportive network focused on empowering each member to achieve 
                        financial security while staying true to our commitment to environmental stewardship.
                        </p>
                        <p class="mb-6">
                        At ENREMCO, we believe in fostering a culture of cooperation and mutual respect. 
                        Through continuous innovation and collaborative efforts, we strive to create opportunities 
                        that help our members thrive both professionally and personally. 
                        Our cooperative spirit drives us to champion responsible practices that benefit our environment, 
                        our members, and the broader community.
                        </p>
                        <p class="font-semibold">
                        Join us and be part of a cooperative where every voice matters, 
                        and every step forward is a shared success.
                        </p>
                    </div>
                </section>
            </div>
